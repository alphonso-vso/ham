    ...
    <x-dialog-modal wire:model="confirmingRecordAddL">
        ...
        <x-slot name="content">
            <div class="col-span-6 sm:col-span-4">
                ...
                <select wire:model.defer="l.id_platillo" id="id_platillo" class="mt-1 block w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm">
