    ...
    <x-dialog-modal wire:model="confirmingRecordAdd">
        ...
        <x-slot name="content">
            <div class="col-span-6 sm:col-span-4">
                ...
                <select wire:model.defer="record.id_dia" id="id_dia" class="mt-1 block w-full border-slate-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm">
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <select wire:model.defer="record.id_platillo" id="id_platillo" class="mt-1 block w-full border-slate-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm">
                    <option value="">{{ __('Selecciona un opción') }}</option>
